...
├── constants/            # Global variables (Chain IDs, Token addresses)
├── pages/                # UI Page Object Models (Locators & Actions)
├── utils/                # Shared helpers (API clients, formatting)
├── tests/
...
# Run with a visual Web Dashboard
K6_WEB_DASHBOARD=true k6 run tests/performance/quote.perf.ts
